...
import io.github.panxiaochao.project.system.infrastructure.convert.ISysTenantPOConvert;
import io.github.panxiaochao.project.system.infrastructure.dao.mapper.SysTenantMapper;
import io.github.panxiaochao.project.system.infrastructure.dao.po.SysTenantPO;
...
public class SysTenantServiceImpl implements ISysTenantService, ISysTenantReadModelService {
     ...
     */
    @Override
    public SysTenantVO getOne(SysTenantQueryDTO queryDto) {
        try {
            // 构造查询条件
            LambdaQueryWrapper<SysTenantPO> lqw = Wrappers.lambdaQuery();
