...
import io.github.panxiaochao.project.system.application.service.SysUserRoleAppService;
 ...
 * @since 2025-12-24
 */
@Tag(name = "系统管理-用户角色表 接口", description = "系统管理-用户角色表 Api接口")
@RequiredArgsConstructor
@RestController
@RequestMapping("/system/v1/sys-user-role")
public class SysUserRoleApi {
    ...
    public R<PageResponse<SysUserRoleQueryVO>> page(@RequestBody SysUserRolePageQueryDTO pageQueryDTO) {
        return R.ok(sysUserRoleAppService.page(pageQueryDTO));
    }

    @Operation(summary = "获取详情", description = "获取详情")
    @Parameter(name = "id", description = "系统管理-用户角色表 ID")
    @GetMapping(value = "/get")
    public R<SysUserRoleVO> getById(@RequestParam Integer id) {
    ...
    @PutMapping
    public R<Void> update(@RequestBody SysUserRoleUpdateDTO sysUserRoleUpdateDTO) {
        return sysUserRoleAppService.update(sysUserRoleUpdateDTO);
    }
