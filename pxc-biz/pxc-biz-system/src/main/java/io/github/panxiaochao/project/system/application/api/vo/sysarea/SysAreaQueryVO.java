package io.github.panxiaochao.project.system.application.api.vo.sysarea;
...
@Setter
@ToString
@Schema(description = "系统管理-全国5级行政区划 查询响应对象")
public class SysAreaQueryVO {
