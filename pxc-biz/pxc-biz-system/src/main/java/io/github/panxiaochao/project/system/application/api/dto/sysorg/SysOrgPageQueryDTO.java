package io.github.panxiaochao.project.system.application.api.dto.sysorg;
...
@Setter
@ToString
@Schema(description = "系统管理-机构部门表 查询分页请求对象")
public class SysOrgPageQueryDTO extends PageRequest {
