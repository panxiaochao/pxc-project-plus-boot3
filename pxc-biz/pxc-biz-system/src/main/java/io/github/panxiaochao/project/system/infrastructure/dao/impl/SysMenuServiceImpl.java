...
import io.github.panxiaochao.project.system.infrastructure.convert.ISysMenuPOConvert;
import io.github.panxiaochao.project.system.infrastructure.dao.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService, ISysMenuReadModelService {
     ...
     */
    @Override
    public SysMenuVO getOne(SysMenuQueryDTO queryDto) {
        try {
            // 构造查询条件
            LambdaQueryWrapper<SysMenuPO> lqw = Wrappers.lambdaQuery();
            lqw.eq(StringUtils.isNotBlank(queryDto.getStatus()), SysMenuPO::getStatus, queryDto.getStatus());
