package io.github.panxiaochao.project.system.application.api.dto.sysarea;
...
@Setter
@ToString
@Schema(description = "系统管理-全国5级行政区划 查询分页请求对象")
public class SysAreaPageQueryDTO extends PageRequest {
