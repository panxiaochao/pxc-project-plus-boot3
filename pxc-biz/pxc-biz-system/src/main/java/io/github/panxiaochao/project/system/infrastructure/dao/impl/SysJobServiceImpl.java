...
import io.github.panxiaochao.project.system.infrastructure.convert.ISysJobPOConvert;
import io.github.panxiaochao.project.system.infrastructure.dao.mapper.SysJobMapper;
...
public class SysJobServiceImpl implements ISysJobService, ISysJobReadModelService {
     ...
     */
    @Override
    public SysJobVO getOne(SysJobQueryDTO queryDto) {
        try {
            // 构造查询条件
            LambdaQueryWrapper<SysJobPO> lqw = Wrappers.lambdaQuery();
