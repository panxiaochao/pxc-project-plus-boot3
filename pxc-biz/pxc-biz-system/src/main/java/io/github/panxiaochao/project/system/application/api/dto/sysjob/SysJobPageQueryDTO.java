package io.github.panxiaochao.project.system.application.api.dto.sysjob;
...
@Setter
@ToString
@Schema(description = "系统管理-定时任务调度表 查询分页请求对象")
public class SysJobPageQueryDTO extends PageRequest {
