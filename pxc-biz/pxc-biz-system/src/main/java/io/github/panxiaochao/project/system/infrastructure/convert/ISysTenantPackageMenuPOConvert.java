...
import io.github.panxiaochao.project.system.infrastructure.dao.po.SysTenantPackageMenuPO;
...
public interface ISysTenantPackageMenuPOConvert {
    ...
    /**
     * 系统管理-租户套餐菜单表 持久化对象 转 系统管理-租户套餐菜单表 响应数据传输对象
     * @param sysTenantPackageMenuPO 系统管理-租户套餐菜单表 持久化对象
     * @return 系统管理-租户套餐菜单表 响应数据传输对象
     */
    SysTenantPackageMenuVO toVO(SysTenantPackageMenuPO sysTenantPackageMenuPO);

    /**
     * 系统管理-租户套餐菜单表 持久化对象列表 转 系统管理-租户套餐菜单表 响应数据传输对象列表
     * @param sysTenantPackageMenuPOList 系统管理-租户套餐菜单表 持久化对象列表
     * @return 系统管理-租户套餐菜单表 响应数据传输对象列表
     */
    List<SysTenantPackageMenuVO> toVO(List<SysTenantPackageMenuPO> sysTenantPackageMenuPOList);
