package io.github.panxiaochao.project.system.application.api.dto.sysuserauths;
...
@Setter
@ToString
@Schema(description = "系统管理-用户授权信息表 查询分页请求对象")
public class SysUserAuthsPageQueryDTO extends PageRequest {
