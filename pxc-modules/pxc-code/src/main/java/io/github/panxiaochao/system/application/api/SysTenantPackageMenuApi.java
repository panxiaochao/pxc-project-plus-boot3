...
@RestController
@RequestMapping("/v1/systenantpackagemenu")
public class SysTenantPackageMenuApi {
    ...
    public R<PageResponse<SysTenantPackageMenuQueryVO>> page(@RequestBody SysTenantPackageMenuPageQueryDTO pageQueryDTO) {
