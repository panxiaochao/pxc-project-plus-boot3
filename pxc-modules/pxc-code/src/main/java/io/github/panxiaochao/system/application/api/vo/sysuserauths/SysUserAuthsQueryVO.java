package io.github.panxiaochao.system.application.api.vo.sysuserauths;
...
@Setter
@ToString
@Schema(description = "系统管理-用户授权信息表 查询响应对象")
public class SysUserAuthsQueryVO {
