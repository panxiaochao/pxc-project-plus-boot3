package io.github.panxiaochao.system.development.application.api.dto.gentable;
...
@Setter
@ToString
@Schema(description = "代码生成表 查询分页请求对象")
public class GenTablePageQueryDTO extends PageRequest {
